...
async function preload() {
  ...
  const bannerAssets = [
    ...
    { key: 'PAGE6_CHAR', url: '/Prototyping-Research/page6/char.png' },
    { key: 'PAGE6_CHAT_1', url: '/Prototyping-Research/page6/chat_1.png' },
    { key: 'PAGE6_CHAT_2', url: '/Prototyping-Research/page6/chat_2.png' },
    { key: 'PAGE6_CHAT_3', url: '/Prototyping-Research/page6/chat_3.png' },
    { key: 'PAGE6_TOKEN_SHOP', url: '/Prototyping-Research/page6/token_shop.png' },
    { key: 'PAGE7_LONG_BACKGROUND_SHOP', url: '/Prototyping-Research/page7/LONG_BACKGROUND_SHOP.png' },
    { key: 'PAGE7_SHOP_1', url: '/Prototyping-Research/page7/shop_1.png' },
    { key: 'PAGE7_SHOP_2', url: '/Prototyping-Research/page7/shop_2.png' },
    { key: 'PAGE8_SUPER_SPINS_BG', url: '/Prototyping-Research/page8/super_spins_bg.png' },
    { key: 'PAGE8_SUPERSPINS_WHEEL', url: '/Prototyping-Research/page8/superspins_wheel.png' },
    { key: 'PAGE8_SUPERSPINS_WHEEL_AFTER', url: '/Prototyping-Research/page8/superspins_wheel_after.png' },
    { key: 'PAGE8_SPIN_BUTTON', url: '/Prototyping-Research/page8/spin_button.png' },
    { key: 'PAGE8_SUPERSPINS_WIN', url: '/Prototyping-Research/page8/superspins_win.png' },
    { key: 'PAGE8_FLIP_TILE', url: '/Prototyping-Research/page8/flip_tile.png' },
    { key: 'PAGE8_FLIP_100', url: '/Prototyping-Research/page8/flip_100.png' },
    { key: 'PAGE8_FLIP_20', url: '/Prototyping-Research/page8/flip_20.png' },
    { key: 'PAGE8_FLIP_5', url: '/Prototyping-Research/page8/flip_5.png' },
    { key: 'PAGE8_FLIP_FP', url: '/Prototyping-Research/page8/flip_fp.png' },
    { key: 'PAGE8_FLIP_SPIN', url: '/Prototyping-Research/page8/flip_spin.png' },
    { key: 'PAGE8_FLIP_100_AFTER', url: '/Prototyping-Research/page8/flip_100_after.png' },
    { key: 'PAGE8_FLIP_20_AFTER', url: '/Prototyping-Research/page8/flip_20_after.png' },
    { key: 'PAGE8_FLIP_5_AFTER', url: '/Prototyping-Research/page8/flip_5_after.png' },
    { key: 'PAGE8_FLIP_SPIN_AFTER', url: '/Prototyping-Research/page8/flip_spin_after.png' },
    { key: 'BANNER_NO_STREAK', url: '/Prototyping-Research/TOPBANNERS/no_streak.png' },
    { key: 'PAGE10_FLAME', url: '/Prototyping-Research/page10/flame.png' },
    { key: 'PAGE10_CHAT_1', url: '/Prototyping-Research/page10/chat_1.png' },
    { key: 'PAGE10_CHAT_2', url: '/Prototyping-Research/page10/chat_2.png' },
    { key: 'PAGE11_LK_BACKGROUND', url: '/Prototyping-Research/page11/lk_background.png' },
    { key: 'PAGE11_LK_CHAR', url: '/Prototyping-Research/page11/lk_char.png' },
    { key: 'PAGE11_LK_CHAT_1', url: '/Prototyping-Research/page11/lk_chat_1.png' },
    { key: 'PAGE11_LK_CHAT_2', url: '/Prototyping-Research/page11/lk_chat_2.png' }
  ];
