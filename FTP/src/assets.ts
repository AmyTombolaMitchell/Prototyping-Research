...
export const ASSETS = {
  ...
  INTRO_BG: 'PAGE 1/BACKGROUND.png',
  INTRO_1: 'PAGE 1/1.png',
  INTRO_2: 'PAGE 1/2.png',
  INTRO_3: 'PAGE 1/3.png',
  INTRO_4: 'PAGE 1/4.png',
  INTRO_5: 'PAGE 1/5.png',
  INTRO_6: 'PAGE 1/6.png',
  INTRO_7: 'PAGE 1/7.png',
  INTRO_8: 'PAGE 1/8.png',
  INTRO_9: 'PAGE 1/9.png',
  INTRO_10: 'PAGE 1/10.png',
  // PAGE 2 assets for second intro scene
  INTRO2_BG: 'PAGE 2/BACKGROUND2.png',
  INTRO2_TOP_BANNER: 'PAGE 2/TOP_BANNER.png',
  INTRO2_1: 'PAGE 2/1.png',
  INTRO2_2: 'PAGE 2/2.png',
  INTRO2_3: 'PAGE 2/3.png',
  // PAGE 3 assets for dice roll scene
  PAGE3_BG: 'PAGE 3/BACKGROUND.png',
  PAGE3_TOP_BANNER: 'PAGE 3/TOP_BANNER.png',
  PAGE3_AVATAR: 'PAGE 3/AVATAR.png',
  PAGE3_DICE: 'PAGE 3/DICE.png',
  PAGE3_EVENT: 'PAGE 3/EVENT.png',
  // PAGE 4 assets for wheel spin scene
  PAGE4_BG: 'PAGE 4/BACKGROUND.png',
  PAGE4_LOGO: 'PAGE 4/LOGO.png',
  PAGE4_SUPERSPINS: 'PAGE 4/SUPERSPINS.png',
  PAGE4_SUPERSPINSLOGOSMALL: 'PAGE 4/SUPERSPINSLOGOSMALL.png',
  PAGE4_WHEEL: 'PAGE 4/WHEEL.png',
